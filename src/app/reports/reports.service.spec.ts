...
describe('ReportsService', () => {
      ...
      .mockResolvedValueOnce([
        {
          ...
          requiresReviewAttemptCount: 1n,
          requiresReviewAttemptAmount: new Prisma.Decimal('150000'),
          successfulRefundCount: 2n,
          successfulRefundAmount: new Prisma.Decimal('75000'),
          reviewRefundCount: 1n,
          reviewRefundAmount: new Prisma.Decimal('25000'),
          openReconciliationIncidentCount: 2n,
  ...
  it('returns stable money strings and zero-filled enum breakdowns', async () => {
    ...
    expect(result.paymentOperations).toEqual({
      ...
      requiresReviewAttemptCount: 1,
      requiresReviewAttemptAmount: '150000.00',
      successfulRefundCount: 2,
      successfulRefundAmount: '75000.00',
      reviewRefundCount: 1,
      reviewRefundAmount: '25000.00',
      openReconciliationIncidentCount: 2,
